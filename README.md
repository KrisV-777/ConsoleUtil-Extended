...
SKSE plugin that allows creation of new console commands using Papyrus. Documentation can be found in the [wiki](https://github.com/KrisV-777/ConsoleUtil-Extended/wiki).
